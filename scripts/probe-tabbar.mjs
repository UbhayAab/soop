...
const list = await page.evaluate(async () => {
  ...
  const out = {
    ...
    // The verb moved from the footer to the search bar at the top of the
    // content: on a phone the footer sat under the floating tab bar.
    newBtn: [...document.querySelectorAll("#panelContent .dmstart button")].some((b) => /new message/i.test(b.textContent)),
  };
  ...
  [...document.querySelectorAll("#panelContent .dmstart button")]
